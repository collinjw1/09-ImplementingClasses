...
class Point(object):
    ...
    def move_to(self,x,y):
        ...
        self.dis_traveled=self.dis_traveled+self.get_distance_from(Point(xx,yy))
    ...
    def closer_to(self, p2, p3):
        dis2=self.get_distance_from(p2)
        dis3=self.get_distance_from(p3)
        if dis2 <= dis3:
            return p2
        if dis2 > dis3:
            return p3
    ...
    def halfway_to(self,point):
        ...
        hadisx=disx*0.5
        hadisy=disy*0.5
        return Point(self.x+hadisx,self.y+hadisy)
    ...
    def get_distance_from_start(self):
        dis=self.get_distance_from(Point(self.startpointx,self.startpointy))
        return dis
